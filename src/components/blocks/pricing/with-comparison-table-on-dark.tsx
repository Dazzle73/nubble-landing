                          ...
                          <li key={feature.name} className="flex gap-x-3">
                            ...
                            <span>
                              ...
                              {typeof (feature.tiers as any)[tier.name] === 'string' ? (
                                <span className="text-sm/6 text-gray-400">({(feature.tiers as any)[tier.name]})</span>
                              ) : null}
                            </span>
                          </li>
                        ) : null,
                      ...
                      <tr key={feature.name}>
                        ...
                        {tiers.map((tier) => (
                          <td key={tier.id} className="px-6 py-4 xl:px-8">
                            {typeof (feature.tiers as any)[tier.name] === 'string' ? (
                              <div className="text-center text-sm/6 text-gray-300">{(feature.tiers as any)[tier.name]}</div>
                            ) : (
                              <>
