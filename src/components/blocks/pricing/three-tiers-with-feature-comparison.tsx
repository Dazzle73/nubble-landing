                                    ...
                                    {typeof (feature.tiers as any)[tier.name] === 'string' ? (
                                      ...
                                      <>
                                        ...
                                        <span className="sr-only">
                                          {(feature.tiers as any)[tier.name] === true ? 'Yes' : 'No'}
                                        </span>
                                      </>
                                    )}
                                  </dd>
                            ...
                            {tiers.map((tier) => (
                              <td key={tier.id} className="relative w-1/4 px-4 py-0 text-center">
                                <span className="relative size-full py-3">
                                  {typeof (feature.tiers as { [key: string]: string | boolean })[tier.name] === 'string' ? (
                                    <span
                                      className={classNames(
                                    ...
                                    >
                                      {(feature.tiers as { [key: string]: string | boolean })[tier.name]}
                                    </span>
                                  ) : (
                                    <>
                                      {(feature.tiers as { [key: string]: string | boolean })[tier.name] === true ? (
                                        <CheckIcon aria-hidden="true" className="mx-auto size-5 text-indigo-600" />
                                      ) : (
                                        <XMarkIcon aria-hidden="true" className="mx-auto size-5 text-gray-400" />
                                      )}
