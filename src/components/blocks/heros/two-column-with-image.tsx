          ...
          {/* <RoughNotationGroup show={isInView}> */}
            ...
            >
              ...
              {/* <RoughNotation
                ...
                multiline
              > */}
                <span className="text-currentColor bg-yellow-400/20 px-2 py-1 rounded">productivity tool</span>
              {/* </RoughNotation> */}{" "}
              ...
              {/* <RoughNotation
                ...
                color="#facc15"
              > */}
                <span className="border-b-2 border-yellow-400">mobile</span>
              {/* </RoughNotation> */}
            </h2>
            <p className="mt-4 max-w-2xl text-center text-sm text-neutral-500 sm:text-left md:mt-10 md:text-lg dark:text-neutral-400">
              ...
              {/* <RoughNotation
                ...
                color="#facc15"
              > */}
                <span className="border-b-2 border-yellow-400">20% discount</span>
              {/* </RoughNotation> */}{" "}
